...
/**
 * Modified the BlockStatusCodeOracle method in the PasswordBruteForceSecurityTestingStrategy strategy
 */
public class StatusCodeAndErrorPatternTestingStrategy extends Strategy {
