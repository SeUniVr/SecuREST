...
/**
 * Modified the BlockStatusCodeOracle method in the CredentialStuffingSecurityTestingStrategy strategy
 */
public class ErrorMessageConsistencyTestingStrategy extends Strategy {
    ...
    public void start() {
        ...
        List<Operation> operations = Environment.getInstance().getOpenAPI().getOperations().stream().collect(Collectors.toList());
